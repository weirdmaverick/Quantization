...
from onnxruntime import SessionOptions, GraphOptimizationLevel, ExecutionMode, InferenceSession, IOBinding
...
# ───────────────────────────────────────────────────────────────────────────────
# 2. ONNX Export (fine-tuned mdoel → ONNX)
# ───────────────────────────────────────────────────────────────────────────────
print(f"[Export] Exporting model to ONNX directory: {ONNX_FP32_DIR}")
...
# ────────────────────────────────────────────────────────────────────────────────────────
# 3. Preprocessing: Symoblic Shape Inference + Graph Optimization + ONNX Shape Inference
# ────────────────────────────────────────────────────────────────────────────────────────
